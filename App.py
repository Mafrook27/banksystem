...
@app.route("/AdminHome")
def AdminHome():
    conn = mysql.connector.connect(user='root', password='', host='localhost', database='1shufflefacepindb')
            ...
            if pin == "nill":
                ...
                for x1 in range(10):
                    if x1 in mylist:
                        ...
                        mylist.append(x1)
                return render_template('Login.html', item=mylist)


@app.route("/userlogin1", methods=['GET', 'POST'])
def userlogin1():
    if request.method == 'POST':
        lkey = request.form['lkey']
        # username = request.form['lkey']
        t0 = request.form['t0']
        t1 = request.form['t1']
        t2 = request.form['t2']
        t3 = request.form['t3']
        ...
        for digit in loginpin:
            print(digit)
            if digit == '0':
                tt0 = int(t0) + int(digit)
                if len(str(tt0)) >= 2:
                    tt0 = str(tt0)
                    tt0 = tt0[1]
                ...
                tt1 = int(t1) + int(digit)
                if len(str(tt1)) >= 2:
                    tt1 = str(tt1)
                    tt1 = tt1[1]
                print(tt1)
            elif digit == '2':
                tt2 = int(t2) + int(digit)
                if len(str(tt2)) >= 2:
                    tt2 = str(tt2)
                    tt2 = tt2[1]
                print(tt2)
            elif digit == '3':
                tt3 = int(t3) + int(digit)
                if len(str(tt3)) >= 2:
                    tt3 = str(tt3)
                    tt3 = tt3[1]
                print(tt3)
            elif digit == '4':
                tt4 = int(t4) + int(digit)
                if len(str(tt4)) >= 2:
                    tt4 = str(tt4)
                    tt4 = tt4[1]
                print(tt4)
            elif digit == '5':
                tt5 = int(t5) + int(digit)
                if len(str(tt5)) >= 2:
                    tt5 = str(tt5)
                    tt5 = tt5[1]
                print(tt5)
            elif digit == '6':
                tt6 = int(t6) + int(digit)
                if len(str(tt6)) >= 2:
                    tt6 = str(tt6)
                    tt6 = tt6[1]
                print(tt6)
            elif digit == '7':
                tt7 = int(t7) + int(digit)
                if len(str(tt7)) >= 2:
                    tt7 = str(tt7)
                    tt7 = tt7[1]
                print(tt7)
            elif digit == '8':
                tt8 = int(t8) + int(digit)
                if len(str(tt8)) >= 2:
                    tt8 = str(tt8)
                    tt8 = tt8[1]
                print(tt8)
            elif digit == '9':
                tt9 = int(t9) + int(digit)
                if len(str(tt9)) >= 2:
                    tt9 = str(tt9)
                    tt9 = tt9[1]
                print(tt9)

            tstring = str(tt0) + str(tt1) + str(tt2) + str(tt3) + str(tt4) + str(tt5) + str(tt6) + str(tt7) + str(
                tt8) + str(tt9)
            print(tstring)
...
def transaction():
    if request.method == 'POST':
        ...
        if Amount < 0:
            ...
            conn1 = mysql.connector.connect(user='root', password='', host='localhost', database='1shufflefacepindb')
